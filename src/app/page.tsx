      ...
      <div className="coming-soon relative w-screen h-screen">
        ...
        <div className="container w-full h-full">
          <div className="text-content w-full h-full flex items-center justify-center relative">
            <div className="content-main flex flex-col items-center lg:w-1/2 sm:w-3/5 w-full text-black/90">
              <Image
                src={"/images/assets/logo.svg"}
                width={100}
                height={80}
                alt="LOGO"
                className="w-44 pb-10 h-full object-cover"
              />
              ...
              <div className="list-link flex items-center gap-6 justify-center mt-6">
                ...
                <Link
                  href={"https://www.instagram.com/glow.middleeast/"}
                  target="_blank"
                >
