            ...
            <div className="coming-soon relative w-screen h-screen">
                ...
                <div className="container w-full h-full">
                    <div className="text-content w-full h-full flex items-center justify-center relative">
                        <div className="content-main flex flex-col items-center lg:w-1/2 sm:w-3/5 w-full text-white">
                            ...
                            <div className="input-block w-full h-[52px] mt-6">
                                <form className='w-full h-full relative' action="post">
                                    <input type="email" placeholder='Enter your e-mail' className='caption1 w-full h-full pl-4 pr-14 rounded-xl border border-line text-black' required />
                            ...
                            <div className="list-link flex items-center gap-6 justify-center mt-6">
                                ...
                                <Link href={'https://www.instagram.com/glow.middleeast/'} target='_blank'>
                                    <div className="icon-instagram text-6xl"></div>
                                </Link>
